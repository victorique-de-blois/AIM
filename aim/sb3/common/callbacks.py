...
from aim.sb3.common import base_class  # pytype: disable=pyi-error
from aim.sb3.common.evaluation import evaluate_policy
from aim.sb3.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization
...
class EvalCallback(EventCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.logger.name_to_value["train/wall_steps"] >= self.next_upd:
            ...
            self.logger.record("eval/wall_steps", self.next_upd // self.eval_freq * self.eval_freq - self.eval_freq)
