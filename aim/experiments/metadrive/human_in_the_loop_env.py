...
import torch as th
from aim.sb3.common.utils import safe_mean
...
HUMAN_IN_THE_LOOP_ENV_CONFIG = {
    ...
    # Reward and cost setting:    "cost_to_reward": True,  # Cost will be negated and added to the reward. Useless in aim.
    "cos_similarity": False,  # If True, the takeover cost will be the cos sim between a_h and a_n. Useless in aim.
    ...
    "only_takeover_start_cost": False,  # If True, only return a cost when takeover starts. Useless in aim.
