...
from aim.experiments.carla.di_drive.core.simulators.carla_data_provider import CarlaDataProvider  # workaround
...
from aim.experiments.carla.di_drive.core.simulators.srunner.tools.openscenario_parser import OpenScenarioParser
