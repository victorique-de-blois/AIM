...
from aim.experiments.carla.di_drive.core.simulators import CarlaSimulator
...
class SimpleCarlaEnv(BaseCarlaEnv):
    ...
    def compute_reward(self) -> Tuple[float, Dict]:
        ...
        lateral_factor = 1
        # from aim.experiments.carla.di_drive.core.utils.simulator_utils.carla_utils import lane_mid_distance
