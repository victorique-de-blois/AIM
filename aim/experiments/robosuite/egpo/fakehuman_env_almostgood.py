...
class CustomWrapper(gym.Env):
    ...
    def predict_agent_future_trajectory(self, current_obs, n_steps, action_behavior = None, return_all_states = False):
        ...
        # task_state = {
        #     "gripper_state": self._env.robots[0].gripper.get_model(),
        # }
        mocap_pos  = self._env.robots[0].controller.joint_pos.copy()
        mocap_quat = self._env.robots[0].controller.sim.get_state()
        ...
        for step in range(n_steps):
            ...
            # self.render()
            step_reward += r
            #TODO: uncomment this to use the real action
            settle_action = np.zeros(7)
    ...
    def decide_takeover(self, obs, future_steps_predict):
        ...
        #TODO: return mean action difference
