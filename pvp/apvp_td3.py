...
class APVPTD3(TD3):
    ...
    def _setup_model(self) -> None:
        super(APVPTD3, self)._setup_model()
    ...
    def _get_torch_save_params(self):
        state_dicts, [] = super(APVPTD3, self)._get_torch_save_params()
        state_dicts.append("classifier")
        return state_dicts, []
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        ## TODO: add a list of new metrics
        """
        dd = ["len_agent_ep", "len_human_ep", "err_agent_rate", "err_human_rate", "err_agent_ep", "err_human_ep", "episode_step", "takeover_current", "total_switch", "total_miss", "total_colorchange", "human_end_takeover", "agent_end_explore"]
        for key in dd:
            if hasattr(self, key):
    ...
    def _store_transition(
        ...
        super(APVPTD3, self)._store_transition(replay_buffer, buffer_action, new_obs, reward, dones, infos)
    ...
    def save_replay_buffer(
        ...
        super(APVPTD3, self).save_replay_buffer(path_replay)
    ...
    def load_replay_buffer(
        ...
        super(APVPTD3, self).load_replay_buffer(path_replay, truncate_last_traj)

    #TODO: write learn classifier from offline data later
