...
from pvp.experiments.metadrive.human_in_the_loop_env_robotgate import HumanInTheLoopEnv
...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_name", default="apvp_metadrive", type=str, help="The name for this batch of experiments.")
