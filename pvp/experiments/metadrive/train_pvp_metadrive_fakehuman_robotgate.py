...
1. use fakehumanenv
2. new config: thr_classifier, thr_actdiff, init_bc_steps, lr_classifier
...
from pvp.experiments.metadrive.egpo.fakehuman_env_robotgate import FakeHumanEnv
from pvp.apvp_td3 import APVPTD3
...
if __name__ == '__main__':
    ...
    experiment_batch_name = "{}_thrclassifier{}".format(args.exp_name, args.thr_classifier)
    seed = args.seed
    ...
    def _make_eval_env():
        ...
        ##in evaluation we do not need robot-gate env.
        from pvp.sb3.common.monitor import Monitor
